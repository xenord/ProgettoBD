...
<html>
    ...
    <body style="background-color:skyblue;font-family:arial;">
        ...
        <h1 style="text-align:center;">Elenco utenti</h1>
        ...
        <table border=1 style='width:100%;text-align:center;font-size:18px;border-collapse: collapse;'>
             ...
             <tr>
                    <?php  
                         ...
                         foreach($res as $rec)
                            {
                            echo"<tr><td>$rec[login]</td><td>$rec[nome]</td><td>$rec[cognome]</td><td>$rec[indirizzo]</td><td>$rec[numerotelefono]</td><td>$rec[admin]</td></tr>";
