...
/*qui ci verranno messe le funzioni per la creazione di query*/    
    ...
    function query_utenti_registrati($dbconn)
    {
            ...
            {
                echo "<font face=arial> $record[login] $record[nome] $record[cognome] $record[indirizzo] $record[password] </font><br>";     
            }
    ...
    function cerca_pizze($dbconn, $parola) {
        ...
        /*$stat = $dbconn->prepare('select nome,prezzo from pizze where nome ilike ?');
